...
// Display copy is Chinese per PRD §9.5. Project status/priority labels match
// web zh-Hans (packages/views/locales/zh-Hans/projects.json); only display
// values change, keys stay untouched.
